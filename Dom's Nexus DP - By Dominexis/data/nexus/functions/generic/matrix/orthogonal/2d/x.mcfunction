...
scoreboard players operation #output_matrix_y_x nexus.value = #output_vector_y nexus.value
scoreboard players operation #output_matrix_y_x nexus.value *= #-1 nexus.value
scoreboard players operation #output_matrix_y_y nexus.value = #output_vector_x nexus.value