...
scoreboard players operation #input_vector_1_x nexus.value = #input_matrix_x_x nexus.value
scoreboard players operation #input_vector_1_y nexus.value = #input_matrix_x_y nexus.value
scoreboard players operation #input_vector_1_z nexus.value = #input_matrix_x_z nexus.value
...
scoreboard players operation #input_vector_2_x nexus.value = #input_matrix_x_x nexus.value
scoreboard players operation #input_vector_2_y nexus.value = #input_matrix_x_y nexus.value
scoreboard players operation #input_vector_2_z nexus.value = #input_matrix_x_z nexus.value
function nexus:generic/vector/cross_product
...
scoreboard players operation #input_vector_x nexus.value = #input_vector_1_x nexus.value
scoreboard players operation #input_vector_y nexus.value = #input_vector_1_y nexus.value
scoreboard players operation #input_vector_z nexus.value = #input_vector_1_z nexus.value
function nexus:generic/vector/normalize/3d
