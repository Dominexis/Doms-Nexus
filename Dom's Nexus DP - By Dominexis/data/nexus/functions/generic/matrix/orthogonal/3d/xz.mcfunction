...
scoreboard players operation #input_vector_1_x nexus.value = #input_matrix_z_x nexus.value
scoreboard players operation #input_vector_1_y nexus.value = #input_matrix_z_y nexus.value
scoreboard players operation #input_vector_1_z nexus.value = #input_matrix_z_z nexus.value
