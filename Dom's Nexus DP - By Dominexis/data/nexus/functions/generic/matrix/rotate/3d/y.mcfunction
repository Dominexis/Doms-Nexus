...
scoreboard players operation #math_vector nexus.value = #input_matrix_x_z nexus.value
scoreboard players operation #math_vector nexus.value *= #math_sine nexus.value
scoreboard players operation #output_matrix_x_x nexus.value = #input_matrix_x_x nexus.value
scoreboard players operation #output_matrix_x_x nexus.value *= #math_cosine nexus.value
...
scoreboard players operation #output_matrix_x_z nexus.value = #input_matrix_x_x nexus.value
scoreboard players operation #output_matrix_x_z nexus.value *= #math_sine nexus.value
...
scoreboard players operation #math_vector nexus.value = #input_matrix_y_z nexus.value
scoreboard players operation #math_vector nexus.value *= #math_sine nexus.value
scoreboard players operation #output_matrix_y_x nexus.value = #input_matrix_y_x nexus.value
scoreboard players operation #output_matrix_y_x nexus.value *= #math_cosine nexus.value
...
scoreboard players operation #math_vector nexus.value = #input_matrix_y_z nexus.value
scoreboard players operation #math_vector nexus.value *= #math_cosine nexus.value
scoreboard players operation #output_matrix_y_z nexus.value = #input_matrix_y_x nexus.value
scoreboard players operation #output_matrix_y_z nexus.value *= #math_sine nexus.value
...
scoreboard players operation #math_vector nexus.value = #input_matrix_z_z nexus.value
scoreboard players operation #math_vector nexus.value *= #math_sine nexus.value
scoreboard players operation #output_matrix_z_x nexus.value = #input_matrix_z_x nexus.value
scoreboard players operation #output_matrix_z_x nexus.value *= #math_cosine nexus.value
...
scoreboard players operation #math_vector nexus.value = #input_matrix_z_z nexus.value
scoreboard players operation #math_vector nexus.value *= #math_cosine nexus.value
scoreboard players operation #output_matrix_z_z nexus.value = #input_matrix_z_x nexus.value
scoreboard players operation #output_matrix_z_z nexus.value *= #math_sine nexus.value
scoreboard players operation #output_matrix_z_z nexus.value += #math_vector nexus.value
