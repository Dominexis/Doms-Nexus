...
scoreboard players operation #output_matrix_x_x nexus.value += #math_term_x nexus.value
scoreboard players operation #output_matrix_x_y nexus.value += #math_term_y nexus.value
scoreboard players operation #output_matrix_x_z nexus.value += #math_term_z nexus.value
