...
scoreboard players operation #output_matrix_x_z nexus.value = #input_matrix_x_y nexus.value
...
scoreboard players operation #math_vector nexus.value = #input_matrix_y_z nexus.value
scoreboard players operation #math_vector nexus.value *= #math_cosine nexus.value
scoreboard players operation #output_matrix_y_z nexus.value = #input_matrix_y_y nexus.value
...
scoreboard players operation #math_vector nexus.value = #input_matrix_z_z nexus.value
scoreboard players operation #math_vector nexus.value *= #math_cosine nexus.value
scoreboard players operation #output_matrix_z_z nexus.value = #input_matrix_z_y nexus.value
