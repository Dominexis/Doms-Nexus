...
scoreboard players operation #math_vector_1 nexus.value = #input_matrix_x_x nexus.value
...
scoreboard players operation #input_y nexus.value = #input_matrix_x_z nexus.value
...
scoreboard players operation #math_vector_0 nexus.value = #output_angle_y nexus.value
...
scoreboard players operation #output_angle_z nexus.value *= #math_vector_0 nexus.value
...
scoreboard players operation #input nexus.value = #output_angle_z nexus.value
function nexus:generic/trigonometry/cosine
...
scoreboard players operation #math_vector_0 nexus.value = #input_matrix_y_y nexus.value
scoreboard players operation #math_vector_0 nexus.value *= #math_cosine_z nexus.value
scoreboard players operation #math_vector_1 nexus.value = #input_matrix_y_x nexus.value
scoreboard players operation #math_vector_1 nexus.value *= #math_sine_z nexus.value
...
scoreboard players operation #math_vector_0 nexus.value = #input_matrix_y_z nexus.value
scoreboard players operation #math_vector_0 nexus.value *= #math_cosine_y nexus.value
scoreboard players operation #math_vector_1 nexus.value = #input_matrix_y_x nexus.value
scoreboard players operation #math_vector_1 nexus.value *= #math_cosine_z nexus.value
scoreboard players operation #math_vector_2 nexus.value = #input_matrix_y_y nexus.value
scoreboard players operation #math_vector_2 nexus.value *= #math_sine_z nexus.value
