...
scoreboard players operation #math_vector nexus.value = #input_vector_y nexus.value
...
scoreboard players operation #math_vector nexus.value /= #1000 nexus.value
scoreboard players operation #output_vector_y nexus.value = #input_vector_x nexus.value
