...
scoreboard players operation #math_term_2 nexus.value = #input_vector_1_z nexus.value
scoreboard players operation #math_term_2 nexus.value *= #input_vector_2_z nexus.value
...
scoreboard players operation #output nexus.value += #math_term_2 nexus.value
