...
scoreboard players operation #output_matrix_y_x nexus.value = #math_quaternion_r nexus.value
scoreboard players operation #output_matrix_y_x nexus.value -= #math_quaternion_i nexus.value
scoreboard players operation #output_matrix_y_x nexus.value -= #math_quaternion_j nexus.value
scoreboard players operation #output_matrix_y_x nexus.value += #math_quaternion_k nexus.value
...
scoreboard players operation #output_matrix_y_y nexus.value = #math_quaternion_r nexus.value
scoreboard players operation #output_matrix_y_y nexus.value -= #math_quaternion_i nexus.value
scoreboard players operation #output_matrix_y_y nexus.value += #math_quaternion_j nexus.value
scoreboard players operation #output_matrix_y_y nexus.value -= #math_quaternion_k nexus.value
...
scoreboard players operation #output_matrix_y_z nexus.value = #math_quaternion_r nexus.value
scoreboard players operation #output_matrix_y_z nexus.value += #math_quaternion_i nexus.value
scoreboard players operation #output_matrix_y_z nexus.value += #math_quaternion_j nexus.value
scoreboard players operation #output_matrix_y_z nexus.value += #math_quaternion_k nexus.value
