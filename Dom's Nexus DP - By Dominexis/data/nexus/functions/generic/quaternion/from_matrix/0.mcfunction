...
scoreboard players operation #output_quaternion_r nexus.value /= #4 nexus.value

scoreboard players operation #output_quaternion_i nexus.value = #input_matrix_y_z nexus.value
scoreboard players operation #output_quaternion_i nexus.value -= #input_matrix_z_y nexus.value
...
scoreboard players operation #output_quaternion_j nexus.value = #input_matrix_z_x nexus.value
scoreboard players operation #output_quaternion_j nexus.value -= #input_matrix_x_z nexus.value
...
scoreboard players operation #output_quaternion_k nexus.value = #input_matrix_x_y nexus.value
scoreboard players operation #output_quaternion_k nexus.value -= #input_matrix_y_x nexus.value
