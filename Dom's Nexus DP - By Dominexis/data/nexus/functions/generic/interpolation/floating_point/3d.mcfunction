...
scoreboard players operation #interpolation_distance_z nexus.value = #interpolation_destination_z nexus.value
...
scoreboard players operation #interpolation_distance_z nexus.value -= #interpolation_location_z nexus.value
...
scoreboard players operation #math_interpolation_2 nexus.value = #interpolation_distance_z nexus.value
...
scoreboard players operation #math_interpolation_2 nexus.value /= #scale_factor nexus.value
...
scoreboard players operation #math_interpolation_2 nexus.value *= #math_interpolation_2 nexus.value
...
scoreboard players operation #input nexus.value += #math_interpolation_2 nexus.value
...
scoreboard players operation #interpolation_acceleration_z nexus.value = #interpolation_distance_z nexus.value
...
scoreboard players operation #interpolation_acceleration_z nexus.value *= #interpolation_acceleration nexus.value
...
scoreboard players operation #interpolation_acceleration_z nexus.value /= #interpolation_distance nexus.value
...
scoreboard players operation #interpolation_velocity_z nexus.value += #interpolation_acceleration_z nexus.value
...
scoreboard players operation #math_interpolation_2 nexus.value = #interpolation_velocity_z nexus.value
scoreboard players operation #math_interpolation_0 nexus.value /= #scale_factor nexus.value
scoreboard players operation #math_interpolation_1 nexus.value /= #scale_factor nexus.value
scoreboard players operation #math_interpolation_2 nexus.value /= #scale_factor nexus.value
scoreboard players operation #math_interpolation_0 nexus.value *= #math_interpolation_0 nexus.value
...
scoreboard players operation #interpolation_velocity_z nexus.value *= #interpolation_numerator nexus.value
...
scoreboard players operation #interpolation_velocity_z nexus.value /= #interpolation_denominator nexus.value
...
scoreboard players operation #interpolation_location_z nexus.value += #interpolation_velocity_z nexus.value