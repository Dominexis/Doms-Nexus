...
scoreboard objectives remove nexus.quaternion_r
scoreboard objectives remove nexus.quaternion_i
scoreboard objectives remove nexus.quaternion_j
scoreboard objectives remove nexus.quaternion_k
