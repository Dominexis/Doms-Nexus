...
scoreboard players add #output nexus.value 20000
...
execute at @s run summon bat ~ ~ ~ {Tags:["nexus.launch.post"],DeathLootTable:"",NoAI:1b,Silent:1b,Health:1.0f,PersistenceRequired:1b}
