...
summon creeper ~ ~8192 ~ {Tags:["nexus.launch","nexus.entity.target.launch","nexus.no_process"],Team:"nexus.vehicle",Silent:1b,Invulnerable:1b,ExplosionRadius:-1b,Fuse:0s,PersistenceRequired:1b}
