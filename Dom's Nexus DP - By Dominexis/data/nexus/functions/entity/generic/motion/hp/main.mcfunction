...
scoreboard players operation #subblock_x nexus.value = #x nexus.value
scoreboard players operation #subblock_y nexus.value = #y nexus.value
scoreboard players operation #subblock_z nexus.value = #z nexus.value
...
scoreboard players operation #motion_x nexus.value %= #500 nexus.value
scoreboard players operation #motion_y nexus.value %= #500 nexus.value
scoreboard players operation #motion_z nexus.value %= #500 nexus.value
...
execute if score #sign_x nexus.value matches 1 run scoreboard players add #motion_x nexus.value 500
execute if score #sign_y nexus.value matches 1 run scoreboard players add #motion_y nexus.value 500
execute if score #sign_z nexus.value matches 1 run scoreboard players add #motion_z nexus.value 500
...
scoreboard players operation #distance_x nexus.value /= #500 nexus.value
scoreboard players operation #distance_y nexus.value /= #500 nexus.value
scoreboard players operation #distance_z nexus.value /= #500 nexus.value
...
function nexus:entity/generic/motion/hp/traverse/main
...
execute if score @s nexus.collide matches 1 if score #motion_halt_boolean nexus.value matches 1 run function nexus:entity/generic/motion/hp/halt
...
function nexus:entity/generic/motion/hp/friction/main
