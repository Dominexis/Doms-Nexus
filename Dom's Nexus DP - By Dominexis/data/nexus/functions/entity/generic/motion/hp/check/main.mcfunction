...
function nexus:entity/generic/motion/hp/check/block/main
...
execute if score #collision_boolean nexus.value matches 1 run function nexus:entity/generic/motion/hp/check/collision/main
...
execute if score #collision_boolean nexus.value matches ..0 run function nexus:entity/generic/motion/hp/traverse/main