...
execute if score #climb_amount nexus.value matches 1.. run function nexus:entity/generic/motion/hv/check/climb/y
...
execute if score #climb_amount nexus.value matches 001 run scoreboard players add @s nexus.y 500
execute if score #climb_amount nexus.value matches 001 run scoreboard players add #subblock_y nexus.value 1
execute if score #climb_amount nexus.value matches 002 run scoreboard players add @s nexus.y 1000
