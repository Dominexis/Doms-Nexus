...
scoreboard players operation #offset_anchor_x nexus.value /= #1000 nexus.value
scoreboard players operation #offset_anchor_y nexus.value /= #1000 nexus.value
scoreboard players operation #offset_anchor_z nexus.value /= #1000 nexus.value
...
scoreboard players operation #offset_x nexus.value /= #1000 nexus.value
scoreboard players operation #offset_y nexus.value /= #1000 nexus.value
scoreboard players operation #offset_z nexus.value /= #1000 nexus.value
...
scoreboard players operation #hitbox_x nexus.value /= #1000 nexus.value
scoreboard players operation #hitbox_y nexus.value /= #1000 nexus.value
scoreboard players operation #hitbox_z nexus.value /= #1000 nexus.value
...
scoreboard players operation #motion_head_x nexus.value %= #1000 nexus.value
scoreboard players operation #motion_head_y nexus.value %= #1000 nexus.value
scoreboard players operation #motion_head_z nexus.value %= #1000 nexus.value
...
execute if score #sign_x nexus.value matches 1 run scoreboard players add #motion_head_x nexus.value 1000
execute if score #sign_y nexus.value matches 1 run scoreboard players add #motion_head_y nexus.value 1000
execute if score #sign_z nexus.value matches 1 run scoreboard players add #motion_head_z nexus.value 1000
...
scoreboard players operation #motion_tail_x nexus.value %= #1000 nexus.value
scoreboard players operation #motion_tail_y nexus.value %= #1000 nexus.value
scoreboard players operation #motion_tail_z nexus.value %= #1000 nexus.value
...
execute if score #sign_x nexus.value matches 1 run scoreboard players add #motion_tail_x nexus.value 1000
execute if score #sign_y nexus.value matches 1 run scoreboard players add #motion_tail_y nexus.value 1000
execute if score #sign_z nexus.value matches 1 run scoreboard players add #motion_tail_z nexus.value 1000
...
scoreboard players operation #distance_head_x nexus.value /= #1000 nexus.value
scoreboard players operation #distance_head_y nexus.value /= #1000 nexus.value
scoreboard players operation #distance_head_z nexus.value /= #1000 nexus.value
...
scoreboard players operation #distance_tail_x nexus.value /= #1000 nexus.value
scoreboard players operation #distance_tail_y nexus.value /= #1000 nexus.value
scoreboard players operation #distance_tail_z nexus.value /= #1000 nexus.value
...
execute if score @s nexus.collide matches 1 if score #motion_halt_boolean nexus.value matches 1 run function nexus:entity/generic/motion/wv/halt
...
function nexus:entity/generic/motion/wv/friction/main
