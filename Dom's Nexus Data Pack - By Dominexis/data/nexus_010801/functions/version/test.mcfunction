...
execute unless score #doms_nexus_version nexus.value = #version nexus.value run function #nexus_010801:error/outdated_nexus
...
schedule function nexus_010801:version/verify 2t replace