...
execute unless score #doms_nexus_version nexus.value = #version nexus.value run function #nexus_010807:error/outdated_nexus
...
schedule function nexus_010807:version/verify 2t replace