...
execute if score #nearest_axis nexus.value matches 0 run function nexus:entity/generic/motion/wv/traverse/head_x
execute if score #nearest_axis nexus.value matches 1 run function nexus:entity/generic/motion/wv/traverse/head_y
execute if score #nearest_axis nexus.value matches 2 run function nexus:entity/generic/motion/wv/traverse/head_z
execute if score #nearest_axis nexus.value matches 3 run function nexus:entity/generic/motion/wv/traverse/tail_x
execute if score #nearest_axis nexus.value matches 4 run function nexus:entity/generic/motion/wv/traverse/tail_y
execute if score #nearest_axis nexus.value matches 5 run function nexus:entity/generic/motion/wv/traverse/tail_z
...
execute if score #motion_end nexus.value matches 0 run function nexus:entity/generic/motion/wv/traverse/main