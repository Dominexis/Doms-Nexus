...
execute if score #motion_climb_boolean nexus.value matches 1.. if score @s nexus.collide_y matches -1 unless score #nearest_axis nexus.value matches 1 run function nexus:entity/generic/motion/wv/check/climb/main
