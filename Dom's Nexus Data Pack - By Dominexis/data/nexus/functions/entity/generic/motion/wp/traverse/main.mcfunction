...
execute if score #nearest_axis nexus.value matches 0 run function nexus:entity/generic/motion/wp/traverse/x
execute if score #nearest_axis nexus.value matches 1 run function nexus:entity/generic/motion/wp/traverse/y
execute if score #nearest_axis nexus.value matches 2 run function nexus:entity/generic/motion/wp/traverse/z
...
execute if score #motion_end nexus.value matches 0 run function nexus:entity/generic/motion/wp/traverse/main