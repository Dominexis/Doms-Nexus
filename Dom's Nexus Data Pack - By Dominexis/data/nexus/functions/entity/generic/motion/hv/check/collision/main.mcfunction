...
execute if score #motion_climb_boolean nexus.value matches 1.. unless score #nearest_axis nexus.value matches 1 run function nexus:entity/generic/motion/hv/check/climb/main
