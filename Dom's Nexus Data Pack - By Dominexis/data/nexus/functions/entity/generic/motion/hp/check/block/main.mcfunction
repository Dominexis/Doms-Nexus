...
execute if score #destructible_boolean nexus.value matches 1 unless score #nearest_axis nexus.value matches 1 run function nexus:entity/generic/motion/hp/check/block/destroy
execute if score #destructible_boolean nexus.value matches 1 if score #nearest_axis nexus.value matches 1 if score #sign_y nexus.value matches 01 run function nexus:entity/generic/motion/hp/check/block/destroy
execute if score #destructible_boolean nexus.value matches 1 if score #nearest_axis nexus.value matches 1 if score #sign_y nexus.value matches -1 if score @s nexus.mot_y >= #downward_speed_floor_destroy_threshold nexus.value run function nexus:entity/generic/motion/hp/check/block/destroy
...
execute if score #boolean nexus.value matches ..0 if block ~ ~ ~ #minecraft:slabs run function nexus:entity/generic/motion/hp/check/block/slab
execute if score #boolean nexus.value matches ..0 if block ~ ~ ~ #minecraft:stairs run function nexus:entity/generic/motion/hp/check/block/stairs
