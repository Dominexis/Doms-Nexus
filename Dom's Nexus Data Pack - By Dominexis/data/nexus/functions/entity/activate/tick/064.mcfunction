...
execute if score @s nexus.id_bool matches 1 as @e[type=#nexus:generic/entity,distance=..064,tag=nexus.entity] if score @s nexus.id = #local nexus.id run tag @s add nexus.entity.target
...
execute if score @s nexus.dmg_s_bool matches 1 as @e[type=#nexus:generic/damage_sensor,distance=..064,tag=nexus.entity.damage_sensor.activate,tag=nexus.entity.target] run function nexus:entity/generic/damage_sensor/tick
...
execute if score @s nexus.id_bool matches 1 if score @s nexus.air_t_bool matches 1 at @s as @e[type=area_effect_cloud,distance=..064,tag=nexus.entity.air_toggle,tag=nexus.entity.target] store result entity @s Air short 1 run scoreboard players get #air_toggle_timer nexus.value
...
execute if score @s nexus.id_bool matches 1 at @s run tag @e[type=#nexus:generic/entity,distance=..064,tag=nexus.entity] remove nexus.entity.target
