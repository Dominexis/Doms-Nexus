...
execute if score @s nexus.id_bool matches 1 as @e[type=#nexus:generic/entity,tag=nexus.entity] if score @s nexus.id = #local nexus.id run tag @s add nexus.entity.target
...
execute if score @s nexus.id_bool matches 1 if score @s nexus.air_t_bool matches 1 as @e[type=area_effect_cloud,tag=nexus.entity.air_toggle,tag=nexus.entity.target] store result entity @s Air short 1 run scoreboard players get #air_toggle_timer nexus.value
...
execute if score @s nexus.id_bool matches 1 run tag @e[type=#nexus:generic/entity,tag=nexus.entity] remove nexus.entity.target
