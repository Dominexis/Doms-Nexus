...
execute if score @s nexus.dmg_s_bool matches 1 as @e[type=#nexus:generic/damage_sensor,distance=..032,tag=nexus.entity.damage_sensor.activate,tag=nexus.entity.target] run function nexus:entity/generic/damage_sensor/tick
