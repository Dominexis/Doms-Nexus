...
execute if score #entity_id_bool nexus.value matches 1 if score #entity_air_t_bool nexus.value matches 1 at @s as @e[type=area_effect_cloud,distance=..032,tag=nexus.entity.air_toggle,tag=nexus.entity.target] store result entity @s Air short 1 run scoreboard players get #air_toggle_timer nexus.value
