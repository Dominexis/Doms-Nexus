...
scoreboard players set #object_tick_time_limit nexus.value 45
...
execute if score #object_tick_time_limit nexus.value matches ..4 run scoreboard players set #object_tick_time_limit nexus.value 5
