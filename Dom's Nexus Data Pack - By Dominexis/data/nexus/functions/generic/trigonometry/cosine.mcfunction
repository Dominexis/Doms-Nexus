...
execute if score #math_trigonometry_0 nexus.value matches ..-1 run scoreboard players operation #math_trigonometry_0 nexus.value *= #-1 nexus.value
scoreboard players remove #math_trigonometry_0 nexus.value 900
