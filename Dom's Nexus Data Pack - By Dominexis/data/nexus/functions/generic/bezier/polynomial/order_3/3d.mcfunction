...
scoreboard players operation #term nexus.value = #bezier_coefficient_1_z nexus.value
scoreboard players operation #term nexus.value *= #power nexus.value
...
scoreboard players operation #output_z nexus.value += #bezier_coefficient_0_z nexus.value