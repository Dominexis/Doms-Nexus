...
execute if score #point_tree_range nexus.value matches 0000..0003 run function nexus:generic/tree/point/yz/z/0
execute if score #point_tree_range nexus.value matches 0004..0015 run function nexus:generic/tree/point/yz/z/1
execute if score #point_tree_range nexus.value matches 0016..0063 run function nexus:generic/tree/point/yz/z/2
execute if score #point_tree_range nexus.value matches 0064..0255 run function nexus:generic/tree/point/yz/z/3
execute if score #point_tree_range nexus.value matches 0256..1023 run function nexus:generic/tree/point/yz/z/4