...
execute if score #index_tree_range nexus.value matches ..16 run function nexus:generic/tree/index/x/layer/end
...
execute if score #index_tree_overflow_boolean nexus.value matches 0 run function nexus:generic/tree/index/x/layer/block/x/2
execute if score #index_tree_x_layer_2 nexus.value matches 4.. run function nexus:generic/tree/index/x/layer/block/x/2