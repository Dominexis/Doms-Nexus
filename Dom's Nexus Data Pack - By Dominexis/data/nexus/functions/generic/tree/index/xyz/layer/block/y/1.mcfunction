...
execute if score #index_tree_overflow_boolean nexus.value matches 0 run function nexus:generic/tree/index/xyz/layer/block/z/1
execute if score #index_tree_z_layer_1 nexus.value matches 4.. run function nexus:generic/tree/index/xyz/layer/block/z/1