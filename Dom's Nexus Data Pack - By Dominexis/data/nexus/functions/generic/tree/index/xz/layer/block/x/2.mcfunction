...
execute if score #index_tree_overflow_boolean nexus.value matches 0 run function nexus:generic/tree/index/xz/layer/block/z/2
execute if score #index_tree_z_layer_2 nexus.value matches 4.. run function nexus:generic/tree/index/xz/layer/block/z/2