...
execute if score #index_tree_z nexus.value < #index_tree_z_range nexus.value if score #index_tree_z_layer_0 nexus.value matches 4.. run function nexus:generic/tree/index/xz/axis/block/z/0
execute if score #index_tree_z nexus.value >= #index_tree_z_range nexus.value run function nexus:generic/tree/index/xz/axis/block/z/main