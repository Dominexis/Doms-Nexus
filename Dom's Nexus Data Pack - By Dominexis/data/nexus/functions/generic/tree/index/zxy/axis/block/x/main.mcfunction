...
execute if score #index_tree_y nexus.value < #index_tree_y_range nexus.value if score #index_tree_y_layer_0 nexus.value matches 4.. run function nexus:generic/tree/index/zxy/axis/block/y/0
execute if score #index_tree_y nexus.value >= #index_tree_y_range nexus.value run function nexus:generic/tree/index/zxy/axis/block/y/main