...
execute if score #index_tree_x nexus.value < #index_tree_x_range nexus.value if score #index_tree_x_layer_0 nexus.value matches 4.. run function nexus:generic/tree/index/zxy/axis/block/x/0
execute if score #index_tree_x nexus.value >= #index_tree_x_range nexus.value run function nexus:generic/tree/index/zxy/axis/block/x/main