...
scoreboard players operation #math_term_2 nexus.value = #input_vector_z nexus.value
scoreboard players operation #math_term_0 nexus.value *= #input_vector_x nexus.value
scoreboard players operation #math_term_1 nexus.value *= #input_vector_y nexus.value
scoreboard players operation #math_term_2 nexus.value *= #input_vector_z nexus.value
...
scoreboard players operation #vector_denominator nexus.value += #math_term_2 nexus.value
...
scoreboard players operation #output_vector_z nexus.value *= #vector_numerator nexus.value
...
scoreboard players operation #output_vector_z nexus.value /= #vector_denominator nexus.value