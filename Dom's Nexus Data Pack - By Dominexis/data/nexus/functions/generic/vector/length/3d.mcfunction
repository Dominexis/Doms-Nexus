...
scoreboard players operation #math_vector_z nexus.value = #input_vector_z nexus.value
...
scoreboard players operation #math_vector_z nexus.value /= #scale_factor nexus.value
...
scoreboard players operation #input nexus.value += #math_vector_z nexus.value
