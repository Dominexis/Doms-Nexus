...
scoreboard players operation #math_matrix_00 nexus.value *= #math_cosine_z nexus.value
scoreboard players operation #math_matrix_00 nexus.value /= #1000 nexus.value
scoreboard players operation #math_matrix_01 nexus.value = #math_sine_y nexus.value
scoreboard players operation #math_matrix_01 nexus.value *= #math_sine_z nexus.value
...
scoreboard players operation #output_matrix_x_y nexus.value = #math_cosine_y nexus.value
...
scoreboard players operation #math_vector nexus.value = #math_sine_x nexus.value
scoreboard players operation #math_vector nexus.value *= #math_matrix_00 nexus.value
scoreboard players operation #output_matrix_y_x nexus.value = #math_cosine_x nexus.value
...
scoreboard players operation #math_vector nexus.value = #math_cosine_x nexus.value
scoreboard players operation #math_vector nexus.value *= #math_matrix_00 nexus.value
scoreboard players operation #output_matrix_z_x nexus.value = #math_sine_x nexus.value
scoreboard players operation #output_matrix_z_x nexus.value *= #math_sine_z nexus.value
...
scoreboard players operation #output_matrix_z_y nexus.value = #math_cosine_x nexus.value
scoreboard players operation #output_matrix_z_y nexus.value *= #math_matrix_01 nexus.value
