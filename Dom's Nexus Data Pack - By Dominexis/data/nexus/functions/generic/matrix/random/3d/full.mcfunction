...
scoreboard players operation #math_00 nexus.value *= #math_sine_pitch nexus.value
scoreboard players operation #math_00 nexus.value /= #1000 nexus.value
scoreboard players operation #math_00 nexus.value *= #math_cosine_roll nexus.value
scoreboard players operation #math_00 nexus.value *= #-1 nexus.value
scoreboard players operation #math_01 nexus.value = #math_sine_yaw nexus.value
scoreboard players operation #math_01 nexus.value *= #math_sine_roll nexus.value
scoreboard players operation #output_matrix_z_x nexus.value = #math_00 nexus.value
scoreboard players operation #output_matrix_z_x nexus.value += #math_01 nexus.value
...
scoreboard players operation #math_01 nexus.value = #math_cosine_yaw nexus.value
scoreboard players operation #math_01 nexus.value *= #math_sine_roll nexus.value
scoreboard players operation #output_matrix_z_y nexus.value = #math_00 nexus.value
scoreboard players operation #output_matrix_z_y nexus.value -= #math_01 nexus.value
scoreboard players operation #output_matrix_z_y nexus.value /= #1000 nexus.value

scoreboard players operation #output_matrix_z_z nexus.value = #math_cosine_pitch nexus.value
scoreboard players operation #output_matrix_z_z nexus.value *= #math_cosine_roll nexus.value
