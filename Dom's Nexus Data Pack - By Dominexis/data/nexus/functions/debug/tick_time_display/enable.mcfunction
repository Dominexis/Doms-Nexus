...
execute if score #debug_system_messages nexus.value matches 1 if score #feature_time_manager nexus.value matches 0 run tellraw @a[tag=nexus.player.operator] ["",{"text":"[","color":"gray"},{"text":"Dom's Nexus","color":"blue","bold":true},{"text":"]","color":"gray"}," ",{"text":"Error: ","color":"dark_red"},{"text":"Tick time display cannot be enabled with time manager disabled.","color":"red"}]
execute if score #debug_system_messages nexus.value matches 1 if score #feature_time_manager nexus.value matches 1 run tellraw @a[tag=nexus.player.operator] ["",{"text":"[","color":"gray"},{"text":"Dom's Nexus","color":"blue","bold":true},{"text":"]","color":"gray"}," ",{"text":"Tick time display enabled.","color":"gray"}]