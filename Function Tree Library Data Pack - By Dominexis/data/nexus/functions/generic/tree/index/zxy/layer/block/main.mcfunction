...
execute if score #index_tree_overflow_boolean nexus.value matches 0 run function nexus:generic/tree/index/zxy/layer/block/z/0
execute if score #index_tree_z_layer_0 nexus.value matches 4.. run function nexus:generic/tree/index/zxy/layer/block/z/0
