...
execute if score #index_tree_range nexus.value matches 0000..0004 run function nexus:generic/tree/index/yzx/layer/x/0
execute if score #index_tree_range nexus.value matches 0005..0016 run function nexus:generic/tree/index/yzx/layer/x/1
execute if score #index_tree_range nexus.value matches 0017..0064 run function nexus:generic/tree/index/yzx/layer/x/2
execute if score #index_tree_range nexus.value matches 0065..0256 run function nexus:generic/tree/index/yzx/layer/x/3
execute if score #index_tree_range nexus.value matches 0257..1024 run function nexus:generic/tree/index/yzx/layer/x/4