...
execute if score #index_tree_range nexus.value matches ..64 run function nexus:generic/tree/index/xyz/layer/end
...
execute if score #index_tree_overflow_boolean nexus.value matches 0 run function nexus:generic/tree/index/xyz/layer/block/x/3
execute if score #index_tree_x_layer_3 nexus.value matches 4.. run function nexus:generic/tree/index/xyz/layer/block/x/3