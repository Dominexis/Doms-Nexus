...
execute if score #index_tree_range nexus.value matches 0000..0004 run function nexus:generic/tree/index/y/layer/y/0
execute if score #index_tree_range nexus.value matches 0005..0016 run function nexus:generic/tree/index/y/layer/y/1
execute if score #index_tree_range nexus.value matches 0017..0064 run function nexus:generic/tree/index/y/layer/y/2
execute if score #index_tree_range nexus.value matches 0065..0256 run function nexus:generic/tree/index/y/layer/y/3
execute if score #index_tree_range nexus.value matches 0257..1024 run function nexus:generic/tree/index/y/layer/y/4