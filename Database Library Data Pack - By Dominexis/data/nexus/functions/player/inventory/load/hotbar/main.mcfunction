...
execute positioned ~ 1024 ~ as @e[type=armor_stand,distance=..2,tag=nexus.entity.type.inventory,tag=nexus.entity.target,limit=1] run function nexus:player/inventory/load/hotbar/entity
