...
execute if score #index_tree_overflow_boolean nexus.value matches 0 run function nexus:generic/tree/index/yzx/layer/block/z/4
execute if score #index_tree_z_layer_4 nexus.value matches 4.. run function nexus:generic/tree/index/yzx/layer/block/z/4