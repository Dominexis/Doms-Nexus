...
execute if score #index_tree_range nexus.value matches 0000..0004 run function nexus:generic/tree/index/z/layer/z/0
execute if score #index_tree_range nexus.value matches 0005..0016 run function nexus:generic/tree/index/z/layer/z/1
execute if score #index_tree_range nexus.value matches 0017..0064 run function nexus:generic/tree/index/z/layer/z/2
execute if score #index_tree_range nexus.value matches 0065..0256 run function nexus:generic/tree/index/z/layer/z/3
execute if score #index_tree_range nexus.value matches 0257..1024 run function nexus:generic/tree/index/z/layer/z/4