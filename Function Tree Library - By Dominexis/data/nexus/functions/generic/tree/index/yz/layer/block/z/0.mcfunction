...
execute if score #index_tree_range nexus.value matches ..4 run function nexus:generic/tree/index/yz/layer/end
...
execute if score #index_tree_overflow_boolean nexus.value matches 0 run function nexus:generic/tree/index/yz/layer/block/y/1
execute if score #index_tree_y_layer_1 nexus.value matches 4.. run function nexus:generic/tree/index/yz/layer/block/y/1