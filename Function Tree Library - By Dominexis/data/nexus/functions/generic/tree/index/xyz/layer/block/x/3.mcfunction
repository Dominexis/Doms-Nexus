...
execute if score #index_tree_overflow_boolean nexus.value matches 0 run function nexus:generic/tree/index/xyz/layer/block/y/3
execute if score #index_tree_y_layer_3 nexus.value matches 4.. run function nexus:generic/tree/index/xyz/layer/block/y/3