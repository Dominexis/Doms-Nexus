...
scoreboard players set #version nexus.value 010805
...
execute unless score #doms_nexus_version nexus.value = #version nexus.value run function #nexus_010805:error/outdated_nexus
...
schedule function nexus_010805:version/verify 2t replace