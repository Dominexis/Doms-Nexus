...
execute store result score #module_count nexus.value if data storage nexus:data modules[{id:"function_tree_library",version:"1.0.0"}]
execute if score #module_count nexus.value matches 0 run scoreboard players set #doms_nexus_error_boolean nexus.value 1
execute if score #module_count nexus.value matches 0 run tellraw @a ["",{"text":"[","color":"gray"},{"text":"Template Module","color":"gold"},{"text":"]","color":"gray"}," ",{"text":"Error: ","color":"dark_red"},{"text":"Function Tree Library","color":"gold","underlined":true,"hoverEvent":{"action":"show_text","value":[{"text":"Dom's Nexus","color":"blue"},{"text":" on ","color":"gray"},{"text":"Planet Minecraft","color":"dark_green"}]},"clickEvent":{"action":"open_url","value":"https://www.planetminecraft.com/data-pack/dom-s-nexus/"}},{"text":" 1.0.0","color":"gold"},{"text":" is not installed.","color":"red"}]
