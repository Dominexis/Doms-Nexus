...
scoreboard players set #point_a_timestamp nexus.value 17
...
scoreboard players set #point_01_a_position nexus.value -400
scoreboard players set #point_01_b_position nexus.value -450
