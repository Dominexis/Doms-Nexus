...
summon area_effect_cloud ~ ~1024 ~ {Tags:["nexus.entity","temp.entity","temp.entity.type.spider_brain","temp.entity.part.damage_sensor"                                                ,"nexus.entity.target.spawn","nexus.entity.air_toggle"],Age:-2147483648,Duration:-1,WaitTime:-2147483648,Passengers:[{id:"minecraft:slime"      ,Tags:["nexus.entity","temp.entity","temp.entity.type.spider_brain","temp.entity.part.damage_sensor"                         ,"nexus.entity.target.spawn","nexus.entity.damage_sensor.event","nexus.entity.foe"],NoAI:1b,Silent:1b,PersistenceRequired:1b,Size:3b,DeathLootTable:"",Attributes:[{Base:1024.0d,Name:"minecraft:generic.max_health"}],Health:1024.0f,ActiveEffects:[{Id:14b,ShowParticles:0b,Duration:2147483647}]}]}
