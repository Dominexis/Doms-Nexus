...
scoreboard players set #input_vector_2_y nexus.value 375
scoreboard players set #input_vector_2_z nexus.value 0
execute if score @s nexus.collide_y matches -1 run scoreboard players set #input_vector_2_y nexus.value -375
...
scoreboard players operation #input nexus.value = @s nexus.mot_y
...
scoreboard players set #input_vector_1_y nexus.value 375
scoreboard players set #input_vector_1_z nexus.value 0
execute if score @s nexus.collide_y matches -1 run scoreboard players set #input_vector_1_y nexus.value -375
...
execute if score @s nexus.mot_y matches 0500.. run playsound minecraft:entity.generic.small_fall neutral @a ~ ~ ~
execute if score @s nexus.mot_y matches ..-500 run playsound minecraft:entity.generic.small_fall neutral @a ~ ~ ~
...
scoreboard players operation @s nexus.mot_y *= #-1 nexus.value