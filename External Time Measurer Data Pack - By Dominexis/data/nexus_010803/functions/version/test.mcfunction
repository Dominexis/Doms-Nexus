...
scoreboard players set #version nexus.value 010803
...
execute unless score #doms_nexus_version nexus.value = #version nexus.value run function #nexus_010803:error/outdated_nexus
...
schedule function nexus_010803:version/verify 2t replace